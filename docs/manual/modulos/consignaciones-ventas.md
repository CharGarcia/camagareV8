...
- **1.30** — Las consignaciones con muchas líneas abren mucho más rápido: los
  lotes de todas las líneas se consultan de una sola vez.
- **1.29** — El botón **PDF** del documento pregunta ahora si se quiere
