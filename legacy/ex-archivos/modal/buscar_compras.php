			...
			<div class="table-responsive">
				<table class="table table-hover">
					...
					while ($row = mysqli_fetch_array($query)) {
						...
						$detalle_retenciones = mysqli_query($con, "SELECT sum(total_retencion) as total_retencion FROM encabezado_retencion WHERE numero_comprobante = '" . $numero_documento . "' and mid(ruc_empresa,1,10) = '" . substr($ruc_empresa, 0, 10) . "' and id_proveedor='" . $id_proveedor . "' group by numero_comprobante");
