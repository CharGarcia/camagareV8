...
?>
	...
	<script>
		...
		function obtener_datos(id) {
			...
			var mod_hora_entrega_desde = $("#mod_hora_entrega_desde" + id).val();
			var mod_hora_entrega_hasta = $("#mod_hora_entrega_hasta" + id).val();
			...
			$("#hora_entrega_desde").val(mod_hora_entrega_desde);
			$("#hora_entrega_hasta").val(mod_hora_entrega_hasta);
			...
			$.ajax({
				...
				beforeSend: function(objeto) {
					$('#muestra_detalle_consignacion').html('<img src="../image/ajax-loader.gif"> Cargando detalle de productos...');
				},
				success: function(data) {
					$(".outer_divdet_consignacion").html(data).fadeIn('fast');
					$('#muestra_detalle_consignacion').html('');
