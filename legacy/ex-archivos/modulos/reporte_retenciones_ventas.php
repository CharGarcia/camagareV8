...
<html lang="es">
  <head>
  <title>Reporte Retenciones ventas</title>
  ...
  <body>
    ...
    <div class="container-fluid">
		...
		<div class="panel-heading">		
			...
			<form class="form-horizontal" id="reporte_retenciones_ventas" method ="POST" action="../excel/reporte_retenciones_ventas.php?action=reporte_retenciones_ventas" >
				<div class="form-group row">
					...
					<div class="col-sm-1">
						<button type="button" class="btn btn-default btn-sm" title="Mostrar reporte"  onclick ='reporte_retenciones_ventas();'><span class="glyphicon glyphicon-search" ></span> Buscar</button>
					</div>
					<div class="col-sm-2">							
...
function reporte_retenciones_ventas(){
         ...
         data: 'action=reporte_retenciones_ventas&fecha_desde='+fecha_desde+'&fecha_hasta='+fecha_hasta,
