...
<div class="container">  
    <div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-search'></i> Cargar detalle de facturas de Ventas</h4>		
		</div>
			...
			<div class="col-md-5">
				<div class="panel panel-info">
					<div class="table table-bordered">
					  <table class="table">
						<tr  class="info">
							<th colspan="2">Cargar detalle de facturas desde excel</th>
						</tr>
						<tr>
			...
			<div class="col-md-7">
				<div class="panel panel-info">
					<div class="table table-bordered">
					  <table class="table">
						<tr  class="info">
							<th colspan="2">Opciones de carga</th>
						</tr>
						<tr>
						<div class="form-group row">
						<td class="col-xs-1">
						<a href="../descargas/cargar_detalle_ventas.xlsx" class="list-group-item list-group-item-warning" target="_blank"><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> Descargar archivo ejemplo </a>	
						</td>
						<td class="col-xs-1">
...
$(function(){
        $("#cargar_archivo").on("submit", function(e){
            ...
            $.ajax({			
                url: "../ajax/cargar_detalle_ventas.php?action=cargar_detalle",
                type: "post",
                dataType: "html",
                data: formData,
