...
?>
	...
	<head>
		<title>Gráfico Ingresos vs Egresos</title>
...
<script>
	...
	function mostrar_char() {
		...
		$.ajax({
			url: '../ajax/analisis_ingresosvsegresos.php?action=analisis_ingresosvsegresos&anio=' + anio,
			beforeSend: function(objeto) {
				$('#loader').html('<img src="../image/ajax-loader.gif">');
			},
			success: function(data) {
				$.each(data, function(i, item) {
					grafico(item.meses, anio, tipo_char, item.sumas_ingresos, item.sumas_egresos);
					$('#loader').html('');
				});
			}
		})
	...
	function grafico(meses, anio, tipo_char, sumas_ingresos, sumas_egresos) {
