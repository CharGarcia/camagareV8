								...
								<div class="form-group">
									<div class="col-sm-12">
										<div class="input-group">
											<span class="input-group-addon"><b>Fuente</b></span>
...
<script type="text/javascript">
	...
	function mostrar_char() {
		...
		$.ajax({
			url: '../ajax/analisis_ventas.php?action=analisis_ventas&fuente='+ fuente +'&anio=' + anio + '&mes=' + mes + '&tipo=' + tipo + '&desde=' + desde + '&hasta=' + hasta + '&dia=' + dia,
