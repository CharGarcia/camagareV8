				...
				<table class="table table-hover">
					...
					while ($row = mysqli_fetch_array($query)) {
						...
						if ($total_observaciones > 0) {
							$observaciones = '<a class="btn btn-warning btn-xs" onclick="revisar_notificaciones_adquisiciones(\'' . $codigo_documento . '\')" title="Detalle documento y observaciones" data-toggle="modal" data-target="#detalleDocumento">Revisar</a>';
						} else {
							$observaciones = '';
						}
