...
if ($action == 'declaracion_iva') {
	...
	if (empty($_POST['mes_semestre'])) {
		...
		$total_ventas_tarifa_cero = $declaracion_iva->detalle_ventas($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'facturas_ventas', '0');
		$total_nc_tarifa_cero = $declaracion_iva->detalle_ventas($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'notas_credito_ventas', '0');

		$total_ventas_tarifa_noobjeto = $declaracion_iva->detalle_ventas($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'facturas_ventas', '6');
		$total_nc_tarifa_noobjeto = $declaracion_iva->detalle_ventas($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'notas_credito_ventas', '6');

		$total_ventas_tarifa_exento = $declaracion_iva->detalle_ventas($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'facturas_ventas', '7');
		$total_nc_tarifa_exento = $declaracion_iva->detalle_ventas($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'notas_credito_ventas', '7');
		...
		$total_compras_diferente_cero = $total_facturas_compras_diferente_cero + $total_liquidacion_compras_diferente_cero;
		...
		$total_compras_tarifa_cero = $declaracion_iva->detalle_compras($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'facturas_compras', '2', '0');
		$total_nc_compras_tarifa_cero = $declaracion_iva->detalle_compras($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'notas_credito_compras', '2', '0');

		$total_compras_tarifa_noobjeto = $declaracion_iva->detalle_compras($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'facturas_compras', '2', '6');
		$total_nc_compras_tarifa_noobjeto = $declaracion_iva->detalle_compras($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'notas_credito_compras', '2', '6');

		$total_compras_tarifa_exento = $declaracion_iva->detalle_compras($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'facturas_compras', '2', '7');
		$total_nc_compras_tarifa_exento = $declaracion_iva->detalle_compras($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'notas_credito_compras', '2', '7');

		$total_liq_compras_tarifa_cero = $declaracion_iva->detalle_compras($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'liquidacion_compra', '2', '0');

		$total_compras_rise_tarifa_doce = $declaracion_iva->detalle_compras($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'notas_de_venta', '2', '2');
		$total_compras_rise_tarifa_cero = $declaracion_iva->detalle_compras($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'notas_de_venta', '2', '0');
		$total_compras_rise_tarifa_noobjeto = $declaracion_iva->detalle_compras($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'notas_de_venta', '2', '6');
		$total_compras_rise_tarifa_exento = $declaracion_iva->detalle_compras($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'notas_de_venta', '2', '7');
		...
		$total_nc_rise_tarifa_doce = $declaracion_iva->detalle_compras($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'nc_notas_de_venta', '2', '2');
		$total_nc_rise_tarifa_cero = $declaracion_iva->detalle_compras($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'nc_notas_de_venta', '2', '0');
		$total_nc_rise_tarifa_noobjeto = $declaracion_iva->detalle_compras($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'nc_notas_de_venta', '2', '6');
		$total_nc_rise_tarifa_exento = $declaracion_iva->detalle_compras($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, 'nc_notas_de_venta', '2', '7');
								...
								<div class="panel panel-info">
									...
									<table class="table">
										...
										<tr>
											...
											<td class="col-md-1 text-right" style="padding: 1px;"><?php echo number_format($ventas_diferentes_cero, 2, '.', ''); ?></td>
											<td class="col-md-1 text-center" style="background: silver; color: rgb(0, 0, 0); padding: 1px;">411</td>
											<td class="col-md-1 text-right" style="padding: 1px;"><?php echo number_format($ventas_diferentes_cero - $nc_ventas_diferentes_cero, 2, '.', ''); ?></td>
											<td class="col-md-1 text-center" style="background: silver; color: rgb(0, 0, 0); padding: 1px;">421</td>
											<td class="col-md-1 text-right" style="padding: 1px;"><?php echo number_format($iva_ventas_diferentes_cero - $iva_nc_ventas_diferentes_cero, 2, '.', ''); ?></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td class="text-right" style="background: #FAAC58; color: rgb(0, 0, 0); padding: 1px;"><?php echo number_format($ventas_diferentes_cero + $total_ventas_tarifa_cero, 2, '.', ''); ?></td>
											<td class="text-center" style="background: #FAAC58; color: rgb(0, 0, 0); padding: 1px;">419</td>
											<td class="text-right" style="background: #FAAC58; color: rgb(0, 0, 0); padding: 1px;"><?php echo number_format($ventas_diferentes_cero + $total_ventas_tarifa_cero - $nc_ventas_diferentes_cero - $total_nc_tarifa_cero, 2, '.', ''); ?></td>
											<td class="text-center" style="background: #FAAC58; color: rgb(0, 0, 0); padding: 1px;">429</td>
											<td class="text-right" style="background: #FAAC58; color: rgb(0, 0, 0); padding: 1px;"><?php echo number_format($iva_ventas_diferentes_cero - $iva_nc_ventas_diferentes_cero, 2, '.', ''); ?></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td class="text-right"><?php echo number_format($ventas_diferentes_cero - $nc_ventas_diferentes_cero, 2, '.', ''); ?></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td class="text-right" style="background: #FAAC58; color: rgb(0, 0, 0); padding: 1px;"><?php echo number_format($ventas_diferentes_cero - $nc_ventas_diferentes_cero, 2, '.', ''); ?></td>
										</tr>
										<tr>
											<td colspan="5">Total comprobantes de venta emitidos</td>
											<td class="text-center" style="background: silver; color: rgb(0, 0, 0);">111</td>
											<td class="text-center"><?php echo number_format($total_facturas_emitidas, 0, '.', ''); ?></td>
											<td colspan="3">Total comprobantes de venta anulados</td>
											<td class="text-center" style="background: silver; color: rgb(0, 0, 0);">113</td>
											<td class="text-center"><?php echo number_format($total_facturas_anuladas, 0, '.', ''); ?></td>
										</tr>
									</table>
								</div>
							</div>
								...
								<div class="panel panel-info">
									...
									<table class="table">
										...
										<tr>
											...
											<td class="text-right"><?php echo number_format($total_compras_diferente_cero, 2, '.', ''); ?></td>
											<td class="text-center" style="background: silver; color: rgb(0, 0, 0);">510</td>
											<td class="text-right"><?php echo number_format($total_compras_diferente_cero - $total_nc_compras_diferente_cero, 2, '.', ''); ?></td>
											<td class="text-center" style="background: silver; color: rgb(0, 0, 0);">520</td>
											<td class="text-right"><?php echo number_format($iva_compras_diferente_cero + $iva_lc_diferente_cero - $iva_nc_compras_diferente_cero, 2, '.', ''); ?></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td class="text-right"><?php echo number_format($total_compras_tarifa_cero + $total_liq_compras_tarifa_cero, 2, '.', ''); ?></td>
											<td class="text-center" style="background: silver; color: rgb(0, 0, 0);">517</td>
											<td class="text-right"><?php echo number_format($total_compras_tarifa_cero + $total_liq_compras_tarifa_cero - $total_nc_compras_tarifa_cero, 2, '.', ''); ?></td>
											<td colspan="2">-</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td class="text-center" style="background: #FAAC58; color: rgb(0, 0, 0); padding: 1px;"><?php echo number_format($total_compras_diferente_cero + $total_liq_compras_tarifa_cero + $total_compras_tarifa_cero + $total_compras_rise, 2, '.', ''); ?></td>
											<td class="text-center" style="background: #FAAC58; color: rgb(0, 0, 0); padding: 1px;">519</td>
											<td class="text-center" style="background: #FAAC58; color: rgb(0, 0, 0); padding: 1px;"><?php echo number_format($total_compras_diferente_cero + $total_liq_compras_tarifa_cero + $total_compras_tarifa_cero + $total_compras_rise - $total_nc_compras_diferente_cero - $total_nc_compras_tarifa_cero - $total_nc_rise, 2, '.', ''); ?></td>
											<td class="text-center" style="background: #FAAC58; color: rgb(0, 0, 0); padding: 1px;">529</td>
											<td class="text-center" style="background: #FAAC58; color: rgb(0, 0, 0); padding: 1px;"><?php echo number_format($iva_compras_diferente_cero + $iva_lc_diferente_cero - $iva_nc_compras_diferente_cero, 2, '.', ''); ?></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<?php
											$suma_factor = $ventas_diferentes_cero - $nc_ventas_diferentes_cero + $total_ventas_tarifa_cero - $total_nc_tarifa_cero;
											$divisor_propocionabilidad = $ventas_diferentes_cero + $total_ventas_tarifa_cero - $nc_ventas_diferentes_cero - $total_nc_tarifa_cero;
										...
										<tr>
											...
											<?php
											$suma_iva_compras = ($iva_compras_diferente_cero  + $iva_lc_diferente_cero - $iva_nc_compras_diferente_cero);
											$valor_sugerido = $suma_iva_compras * $resultado_factor;
											?>
										...
										<tr>
											...
											<td class="text-center"><?php echo number_format($numero_total_facturas_compras + $numero_total_notas_credito_compras + $numero_total_notas_debito_compras, 0, '.', ''); ?></td>
											<td colspan="3">Total notas de venta recibidas</td>
											<td class="text-center" style="background: silver; color: rgb(0, 0, 0);">117</td>
											<td class="text-center"><?php echo number_format($numero_total_notas_venta, 0, '.', ''); ?></td>
										</tr>
										<tr>
											...
											<td class="text-right"><?php echo number_format($numero_total_liquidaciones_compras, 0, '.', ''); ?></td>
										</tr>
									</table>
								...
								<div class="panel panel-info">
									<table class="table">
										...
										<tr>
											...
											<?php
											$impuesto_causado = (($iva_ventas_diferentes_cero - $iva_nc_ventas_diferentes_cero) - $valor_sugerido) > 0 ? (($iva_ventas_diferentes_cero - $iva_nc_ventas_diferentes_cero) - $valor_sugerido) : 0;
											$credito_tributario = (($iva_ventas_diferentes_cero - $iva_nc_ventas_diferentes_cero) - $valor_sugerido) < 0 ? (($iva_ventas_diferentes_cero - $iva_nc_ventas_diferentes_cero) - $valor_sugerido) * -1 : 0;
											?>
...
class declaracion_iva
{
	...
	public function detalle_ventas($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, $tabla, $tarifa_iva)
	{
	...
	//para sacar detalle de encabezado y detalle de ventas y notas de credito por ventas
	public function detalle_compras($con, $datos_declaracion, $mes_semestre, $anio, $ruc_empresa, $tabla, $tipo_impuesto, $tarifa_iva)
	{
		$inicio_primer_semestre = "'" . date("Y-m-d", strtotime($anio . "-01-01")) . "'";;
		$final_primer_semestre = "'" . date("Y-m-d", strtotime($anio . "-06-30")) . "'";
		$inicio_segundo_semestre = "'" . date("Y-m-d", strtotime($anio . "-07-01")) . "'";
