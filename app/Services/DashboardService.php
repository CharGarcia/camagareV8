...
class DashboardService
{
    ...
    public function getDashboardData(int $idEmpresa): array
    {
        return [
            'ventas_mes_actual' => $this->getTotalVentasMes($idEmpresa, 0),
            'ventas_mes_anterior' => $this->getTotalVentasMes($idEmpresa, 1),
            'compras_mes_actual' => $this->getTotalComprasMes($idEmpresa, 0),
            'compras_mes_anterior' => $this->getTotalComprasMes($idEmpresa, 1),
            'facturas_recientes' => $this->getVentasRecientes($idEmpresa, 5),
            'compras_recientes' => $this->getComprasRecientes($idEmpresa, 5),
            'tendencia_6_meses' => $this->getTendenciaMensual($idEmpresa, 6),
        ];
    }

    private function getTotalVentasMes(int $idEmpresa, int $mesesAtras): float
    {
    ...
    private function getVentasRecientes(int $idEmpresa, int $limit): array
    {
    ...
    private function getTendenciaMensual(int $idEmpresa, int $meses): array
    {
        ...
        $stV->execute([':id_empresa' => $idEmpresa]);
