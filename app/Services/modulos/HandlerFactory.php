                    ...
                    'generar_facturacion' => [
                        ...
                        'parametros'  => [
                            ...
                            ['key' => 'texto_item', 'label' => 'Texto adicional en cada ítem (opcional)', 'tipo' => 'text', 'default' => '',
                             'ayuda' => 'Texto en cada producto de la factura. Puede usar etiquetas dinámicas: {mes}, {MES}, {mes_num}, {anio}, {mes_anio}, {fecha}. Ej: "Suscripción de {mes_anio}".'],
                            ['key' => 'info_concepto', 'label' => 'Concepto de info. adicional (opcional)', 'tipo' => 'text', 'default' => '',
                             'ayuda' => 'Nombre del campo de información adicional. Acepta etiquetas dinámicas. Ej: "Período".'],
                            ['key' => 'info_detalle', 'label' => 'Detalle de info. adicional (opcional)', 'tipo' => 'text', 'default' => '',
                             'ayuda' => 'Valor de la info. adicional. Acepta etiquetas: {mes}, {anio}, {mes_anio}... Ej: "{mes_anio}". Requiere también el concepto.'],
                        ],
                    ],
