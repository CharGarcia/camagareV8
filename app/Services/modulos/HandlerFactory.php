                    ...
                    'avisar_iva_a_pagar' => [
                        ...
                        'parametros'  => [
                            ...
                            ['key' => 'asunto', 'label' => 'Asunto del correo', 'tipo' => 'text', 'default' => 'IVA a pagar {periodo}: {iva_a_pagar}',
                             'ayuda' => 'Etiquetas: {empresa} {periodo} {iva_ventas} {notas_credito} {credito_tributario} {notas_credito_compra} {retenciones} {iva_a_pagar} {saldo_favor} {fecha_limite}.'],
                            ['key' => 'cuerpo', 'label' => 'Mensaje (antes del desglose)', 'tipo' => 'textarea',
                             ...
                             'ayuda' => 'Texto antes de la tabla de desglose. Mismas etiquetas: {empresa} {periodo} {iva_ventas} {notas_credito} {credito_tributario} {notas_credito_compra} {retenciones} {iva_a_pagar} {saldo_favor} {fecha_limite}. El desglose se agrega automáticamente debajo.'],
                        ],
                    ],
                ],
            ],
