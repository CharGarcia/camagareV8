...
class SriDescargaAutomaticaService
{
    ...
    /**
     * Dado un conjunto de CLAVES de acceso (recolectadas por la extensión del cliente en el
     * portal del SRI), descarga cada XML por el webservice oficial (sin captcha) y lo registra.
