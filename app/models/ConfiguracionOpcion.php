...
class ConfiguracionOpcion extends BaseModel
{
    ...
    public function asegurarOpcionesBase(): void
    {
        ...
        $base = [
            ...
            ['nombre' => 'Perfiles de mapeo de cobros', 'descripcion' => 'Formatos de los estados de cuenta de cada banco (Excel/PDF) que usa Conciliación de Cobros', 'icono' => 'bank', 'clase_color' => 'success', 'nivel_minimo' => 3, 'enlace' => ['etiqueta' => 'Configurar', 'ruta' => '/config/conciliacion-perfiles', 'clase_btn' => 'success']],
            ['nombre' => 'Perfiles de lectura de tarjetas', 'descripcion' => 'Formatos de los estados de cuenta de Payphone, Nuvei y datáfonos (Excel/CSV/PDF) que usa Conciliación de Tarjetas', 'icono' => 'credit-card', 'clase_color' => 'success', 'nivel_minimo' => 3, 'enlace' => ['etiqueta' => 'Configurar', 'ruta' => '/config/conciliacion-tarjetas-perfiles', 'clase_btn' => 'success']],
