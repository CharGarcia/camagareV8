...
class Application
{
    ...
    public function run(): void
    {
        ...
        $publicControllers = ['Auth', 'Registro', 'SolicitudFirma', 'FacturaExpressPublico', 'WhatsappWebhook', 'Reservas', 'Payphone', 'CargasInventarioAprobacion', 'Asistencia', 'ImportacionesAprobacion', 'TransferenciasAprobacion', 'AceptacionDocumentos', 'PedidoPublico'];
