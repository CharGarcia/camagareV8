...
class Application
{
    ...
    public function run(): void
    {
        ...
        $publicControllers = ['Auth', 'Registro', 'SolicitudFirma', 'FacturaExpressPublico', 'WhatsappWebhook', 'Reservas', 'Payphone', 'Nuvei', 'CargasInventarioAprobacion', 'Asistencia', 'ImportacionesAprobacion', 'TransferenciasAprobacion', 'AceptacionDocumentos', 'PedidoPublico', 'VideollamadaInvitado', 'ProformaAprobacion', 'OrdenCompraAprobacion', 'ComprasAprobacion', 'SolicitudVacaciones', 'RecepcionTransferencia'];
