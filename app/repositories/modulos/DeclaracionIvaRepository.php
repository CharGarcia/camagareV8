...
class DeclaracionIvaRepository extends BaseRepository
{
    ...
    public function insertDeclaracion(array $data): int
    {
        $sql = "INSERT INTO declaracion_iva_cabecera (
                    ...
                    retenciones_iva, credito_anterior_aplicado, iva_a_pagar, total_a_pagar, saldo_favor,
                    ...
                    :retenciones, :credito_ant, :a_pagar, :total_pagar, :saldo_favor,
    ...
    public function updateDeclaracion(int $id, int $idEmpresa, array $data): void
    {
        $sql = "UPDATE declaracion_iva_cabecera SET
                    ...
                    iva_a_pagar = :a_pagar, total_a_pagar = :total_pagar, saldo_favor = :saldo_favor,
    ...
    private function mapDeclaracionParams(array $data): array
    {
        return [
            ...
            ':total_pagar'     => (float) ($data['total_a_pagar'] ?? $data['iva_a_pagar']),
