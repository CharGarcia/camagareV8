...
class RetencionVentaRepository extends BaseRepository
{
    ...
    public function getListado(
        ...
        // período fiscal y los totales (renta, IVA, ISD y su suma).
        //
        ...
        //   - Origen (tipo) → modal de filtros (decisión anterior).
        //   - Clave de acceso → filtro `clave:` (17-09-2026). Son 49 dígitos —fecha, RUC,
        //     serie, secuencial y un código numérico aleatorio de 8—, así que al escribir
