...
class AuditoriaEtiquetas
{
    ...
    private const MAP = [
        ...
        'tareas'                         => 'Tareas',
        'taller_departamentos'           => 'Departamentos del taller',
        'taller_ordenes'                 => 'Órdenes de taller',
        'taller_ordenes_detalle'         => 'Órdenes de taller (repuestos y mano de obra)',
        'taller_ordenes_etapas'          => 'Órdenes de taller (departamentos)',
