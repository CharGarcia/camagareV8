            ...
            <div class="modal-body p-0">
                <form id="formNC">
                    ...
                    <div class="px-3 py-2 bg-light border-bottom d-flex gap-1 align-items-center flex-wrap">
                        ...
                        <button id="nc-btn-excel" type="button" class="btn btn-outline-success btn-sm px-2" onclick="window.NC_exportarExcel()" title="Exportar Excel" disabled><i class="bi bi-file-earmark-excel"></i></button>
                    ...
                    <div class="tab-content border-top">
                        ...
                        <div class="tab-pane fade p-3" id="tab-nc-contable" role="tabpanel">
                            <?php $prefijo = 'nc'; require MVC_APP . '/views/partials/asiento_tab.php'; ?>
                        </div>
                        <?php endif; ?>
