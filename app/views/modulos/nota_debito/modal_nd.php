            ...
            <div class="modal-body p-0">
                <form id="formND">
                    ...
                    <div class="px-3 py-2 bg-light border-bottom d-flex gap-1 align-items-center flex-wrap">
                        ...
                        <button id="nd-btn-excel" type="button" class="btn btn-outline-success btn-sm px-2" onclick="window.ND_exportarExcel()" title="Exportar Excel" disabled><i class="bi bi-file-earmark-excel"></i></button>
