            ...
            <div class="modal-body p-0">
                <form id="formFR">
                    ...
                    <div class="px-3 py-2 bg-light border-bottom d-flex gap-1 align-items-center flex-wrap">
                        ...
                        <button id="fr-btn-excel" type="button" class="btn btn-outline-success btn-sm px-2" onclick="window.FR_exportarExcel()" title="Exportar Excel" disabled><i class="bi bi-file-earmark-excel"></i></button>
