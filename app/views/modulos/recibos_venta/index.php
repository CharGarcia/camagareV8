                            ...
                            <div class="border rounded-3 overflow-hidden bg-white shadow-sm">
                                <div class="table-responsive" style="max-height: 350px;">
                                    <table class="table table-sm table-detalle mb-0 text-nowrap" id="table-asiento-contable">
                                        ...
                                        <tfoot class="bg-light fw-bold border-top sticky-bottom">
                                            ...
                                            <!-- Cuadre contra el recibo: se mide sobre la línea de cuenta por cobrar,
                                            ...
                                            <tr class="border-top">
                                                <td class="text-end py-2 fw-normal small text-muted">Total del recibo:</td>
                                ...
                                <div class="p-2 border-top bg-light d-flex justify-content-between align-items-center">
                                    <span class="small text-muted ps-2">
                                        <i class="bi bi-info-circle me-1"></i> El asiento lo calcula el sistema a partir del recibo.
                                    </span>
                                    <div class="small fw-bold text-muted pe-3">
...
<script>
    ...
    // El asiento lo calcula SIEMPRE el sistema a partir del recibo: esta pestaña es de
    ...
    window.fvRecalcularTotalesAsiento = function() {
        ...
        // Cuadre contra el total del recibo. Se mide sobre la línea de cuenta por cobrar,
        ...
        const totalRecibo   = parseFloat(document.getElementById('m-lbl-total')?.textContent) || 0;
        ...
        if (lblTotalFact) lblTotalFact.textContent = totalRecibo.toFixed(2);
        ...
        if (lblCuadreFact) {
            if (filas.length === 0) {
            ...
            } else if (Math.abs(debeAncla - totalRecibo) < 0.005) {
                ...
                lblCuadreFact.textContent = 'Cuenta por cobrar del asiento: ' + debeAncla.toFixed(2)
                                          + ' · diferencia: ' + Math.abs(debeAncla - totalRecibo).toFixed(2);
                lblCuadreFact.className = 'x-small fw-bold text-danger';
            }
        }
