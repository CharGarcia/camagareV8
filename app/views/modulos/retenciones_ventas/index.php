...
<style>
    .retv-scroll { max-height: calc(100dvh - 240px); overflow-y: auto; }
...
<script src="<?= rtrim($base, "/") ?>/js/modulos/retenciones_ventas.js?v=<?= asset_ver('/js/modulos/retenciones_ventas.js') ?>" defer></script>
