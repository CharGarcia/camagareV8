        ...
        <div class="categorias-scroll">
            <table class="table table-hover table-sm mb-0 align-middle">
                <thead class="table-light shadow-sm">
                    <tr>
                        <th class="ps-3 sortable-header" data-sort="nombre" data-col="nombre" role="button">Nombre de la Categoría <i class="bi bi-arrow-down-up small text-muted ms-1"></i></th>
...
<script>
    (function() {
        ...
        window.CMG_initSort('categorias', (col, dir) => {
            currentSort = col;
            currentDir = dir;
            fetchSearch(1);
