        ...
        <div class="d-flex align-items-center gap-2 flex-wrap">
            ...
            <div id="fmExtraCAM" class="btn-group btn-group-sm">
                <?= \App\Helpers\PreferenciasHelper::renderDropdownColumnas([
                    ...
                    'dev_lote'      => 'Entra: lote',
                    'dev_nup'       => 'Entra: NUP',
                    'dev_caducidad' => 'Entra: vencimiento',
                    ...
                    'ent_lote'      => 'Sale: lote',
                    'ent_nup'       => 'Sale: NUP',
                    'ent_caducidad' => 'Sale: vencimiento',
            ...
            <table class="table table-hover table-sm mb-0" id="tablaCambios">
                ...
                <thead class="table-light">
                    <tr>
                        ...
                        <th class="sortable-header cam-th-entra" role="button" data-col="dev_caducidad" title="Fecha de vencimiento del producto que entra">Vencimiento <i class="bi bi-arrow-down-up small ms-1"></i></th>
                        ...
                        <th class="sortable-header cam-th-sale" role="button" data-col="ent_caducidad" title="Fecha de vencimiento del producto que sale">Vencimiento <i class="bi bi-arrow-down-up small ms-1"></i></th>
...
<script>
    ...
    async function cargarGrid() {
        ...
        if (window.CPCV_busquedaCtrl) window.CPCV_busquedaCtrl.abort();
        const ctrl = new AbortController();
        window.CPCV_busquedaCtrl = ctrl;
        try {
            ...
            const res = await fetch(`${RUTA_MODULO_CAMBIO}/searchAjax?${params.toString()}`, { signal: ctrl.signal });
            if (!res.ok) throw new Error('Error en red');
            const data = await res.json();
            if (ctrl !== window.CPCV_busquedaCtrl) return;
            ...
            if (tbody && ctrl === window.CPCV_busquedaCtrl) tbody.classList.remove('fm-cargando-target');
        }
    }
</script>
