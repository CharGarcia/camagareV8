        ...
        <div class="modal-content border-0 shadow-lg">
            <form id="formProducto" novalidate onsubmit="return false;">
                ...
                <div class="modal-body p-0">
                                ...
                                <div class="col-md-12">
                                    <div class="p-3 border rounded bg-light bg-opacity-50">
                                        ...
                                        <div class="form-check mt-2 pt-2 border-top">
                                            <input class="form-check-input" type="checkbox" name="precio_editable_comanda" id="prod_precio_editable_comanda" value="1">
                    ...
                    <div class="d-none border-top px-3 py-2 bg-light" id="prod_replicar_wrap">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="prod_replicar_toggle">
                            <label class="form-check-label small fw-bold" for="prod_replicar_toggle">
                                <i class="bi bi-building-fill-check me-1"></i>Aplicar también en otras empresas
                            </label>
                        </div>
                        <div class="d-none mt-2" id="prod_replicar_lista_wrap">
                            <div class="small text-muted mb-1">
                                Busque y agregue las empresas donde aplicar este producto. Si ya existe allí (mismo código), no se duplica ni se sobrescribe.
                            </div>
                            <select class="form-select form-select-sm" id="prod_replicar_select" name="ids_empresa_destino[]" multiple></select>
                        </div>
                    </div>
                </div>
